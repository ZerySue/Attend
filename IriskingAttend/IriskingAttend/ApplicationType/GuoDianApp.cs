...
{
    public class GuoDianApp : AbstractApp
    {
        private AbstractApp BaseApp;

        public GuoDianApp(AbstractApp BaseApp)
        {
        ...
        public override Dictionary<PrivilegeENUM, bool> GetDictPrivilegeListVisible()
        {
            ...
            dictPrivilegeList[PrivilegeENUM.ReportGuoDian] = true;  //国电报表
