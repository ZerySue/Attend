/*************************************************************************
** 文件名:   LinZhouZhuDuanApp.cs
** 主要类:   LinZhouZhuDuanApp
**  
...
** 修改人:   
** 日  期:
** 描  述:   LinZhouZhuDuanApp，林州铸锻煤矿应用程序类型
**
** 版  本:   1.0.0
** 备  注:  命名及代码编写遵守C#编码规范
**
...
{
    public class LinZhouZhuDuanApp : AbstractApp
    {
        private AbstractApp BaseApp;

        public LinZhouZhuDuanApp(AbstractApp BaseApp)
        {
        ...
        public override Dictionary<PrivilegeENUM, bool> GetDictPrivilegeListVisible()
        {
            ...
            dictPrivilegeList[PrivilegeENUM.ReportZhuDuanMonthAttend] = true;  //林州铸锻月报表       
